...
const Project = () => {
  ...
  return (
    <>
      <div id="projects" className='flex flex-col gap-y-15 py-9 lg:px-10 px-3 text-center lg:py-10 z-10 w-full'>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-4 gap-y-4 place-items-center">
          {project?.map((e, index) => (
            ...
            >
              ...
              />
              <div className="lg:group-hover:bottom-0 flex flex-col lg:gap-y-7 justify-center gap-y-5 px-5 py-5 items-start bg-gray-700/70 w-full h-full lg:absolute lg:bottom-[-200%] lg:transition-all lg:duration-600">
