...
const HeroSection = () => {
  return (
    <>
      <div className=" lg:px-10 px-0 lg:py-20 py-2 flex lg:flex-row flex-col gap-x-15 lg:gap-y-0 gap-y-10 justify-center items-center z-10 w-[80%] mx-auto">
        ...
        <div className="lg:w-1/2 w-full flex flex-col gap-y-6 lg:text-start text-center">
          <div className="flex flex-col gap-4">
            ...
            <p className="lg:text-3xl text-xl font-semibold">Full Satck Web Devloper</p>
          </div>
