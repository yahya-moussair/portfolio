...
const About = () => {
  return (
    <>
      <div
        id="about"
        className="flex lg:flex-row lg:items-center flex-col-reverse gap-x-15 lg:gap-y-0 gap-y-10 bg-white/10 backdrop-blur-md border border-white/10 shadow-md py-9 lg:px-30 px-3 lg:text-start text-center lg:py-10 z-10 w-full"
      >
